...
},{"./lib/v1":4}],2:[function(require,module,exports){
...
},{"lodash":8,"request":7}],4:[function(require,module,exports){
var _ = require('lodash');
...
},{"./players":5,"./zones":6,"lodash":8}],5:[function(require,module,exports){
...
function Players(client, param, opts) {
  ...
  this.seek = actions._seek.bind(this, 'roomName');
...
/**
 * Clear the queue for the configured player
 *
 * @param {function} cb - Callback function
 */
Players.prototype.clearQueue = function(cb) {
  if (!this.params.roomName) {
    throw new Error('roomName must be supplied to players() for actions');
  }

  var pathname = this.pathname.replace(':action', 'queue/clear');
  var value = this.params.roomName;
  var prefix = ':';
...
/**
 * Obtain the current queue for the configured player
 *
 * @param {object} opts - Optional filtering/query params
 * @param {function} cb - Callback function
 */
Players.prototype.queue = function(opts, cb) {
  if (_.isFunction(opts)) {
    cb = opts;
    opts = {};
  }
  ...
  var pathname = this.pathname.replace(':action', 'queue');
  var value = this.params.roomName;
  var prefix = ':';

  pathname = pathname.replace(prefix + 'roomName', value);

  this.client.get(pathname, opts, function(err, body) {
    if (err) {
      return cb(err);
    }
...
},{"../actions":2,"../client":3,"lodash":8}],6:[function(require,module,exports){
var Client = require('../client').Client;
var actions = require('../actions');
...
},{"../actions":2,"../client":3,"lodash":8}],7:[function(require,module,exports){
// Browser Request
//
